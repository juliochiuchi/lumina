...
import { Pencil, Trash2, Tag, DollarSign, Clock3, ArrowUpRight, ArrowDownRight, Search } from 'lucide-react'
      ...
      <div className="flex items-center gap-2">
        <div className="group relative">
          <Button
            ...
            aria-label="Consultar detalhes"
            className="peer h-8 w-8 rounded-md text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-100"
          >
            <Search className="h-4 w-4" />
          </Button>
          <span className="pointer-events-none absolute right-0 top-full z-10 mt-1.5 whitespace-nowrap rounded-md border border-zinc-700/70 bg-zinc-950/95 px-2 py-0.5 text-[10px] font-medium text-zinc-200 opacity-0 shadow-md transition-opacity duration-150 peer-hover:opacity-100">
            Consultar detalhes
          </span>
        </div>
